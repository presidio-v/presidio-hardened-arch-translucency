...
(`pat export`). Chart 0.24.0 ships the exporter, measured/modelled energy panels,
...
```bash
docker build --build-arg VERSION=0.24.0 -t ghcr.io/presidio-v/pat-exporter:0.24.0 .
```
